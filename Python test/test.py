# Follow the instructions in the lab document to calculate the mortgage
#information.
# Everytime you have a new value to output to the screen, make sure to use the
#proper variable from below.
